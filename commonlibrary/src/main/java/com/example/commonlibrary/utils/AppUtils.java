...
import com.example.commonlibrary.base.ActivityLifecycleImpl;
import com.example.commonlibrary.base.OnAppStatusChangedListener;

import java.lang.reflect.InvocationTargetException;
import java.util.List;

/**
 * 主要还是用来获取一下application对象
 */
public class AppUtils {
    ...
    public static void addStateListener(Object object, OnAppStatusChangedListener listener) {
