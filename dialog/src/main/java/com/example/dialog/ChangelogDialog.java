...
public class ChangelogDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                .theme(requireArguments().getBoolean("dark_theme") ? Theme.DARK : Theme.LIGHT)
        ...
        try {
            ...
            InputStream json = requireActivity().getAssets().open("changelog.html");
            ...
            final int accentColor = requireArguments().getInt("accent_color");
            webView.loadData(buf.toString()
                            .replace("{style-placeholder}", requireArguments().getBoolean("dark_theme") ?
