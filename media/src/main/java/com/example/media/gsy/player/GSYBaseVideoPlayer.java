...
import com.example.media.gsy.helper.SmallVideoTouch;
import com.example.media.gsy.utils.CommonUtil;
import com.example.media.gsy.utils.OrientationUtils;

import java.lang.reflect.Constructor;

public abstract class GSYBaseVideoPlayer extends GSYVideoControlView {
    private static final String TAG = "GSYBaseVideoPlayer";
    ...
    protected boolean isVerticalVideo() {
        ...
        Log.d(TAG, "GSYVideoBase isVerticalVideo  videoHeight " + videoHeight + " videoWidth " + videoWidth);
        Log.d(TAG, "GSYVideoBase isVerticalVideo  mRotate " + mRotate);
    ...
    protected void checkAutoFullSizeWhenFull() {
        if (mIfCurrentIsFullscreen) {
            ...
            Log.d(TAG, "GSYVideoBase onPrepared isVerticalFullByVideoSize " + isV);
            if (isV) {
                if (mOrientationUtils != null)
