...
import com.wali.live.wechat.common.MMAlert;
import com.wali.live.wechat.utils.CameraUtil;
...
public class SendToWXActivity extends Activity {
    ...
    private void initView() {
        ...
        findViewById(R.id.send_text).setOnClickListener(v -> {
            ...
            MMAlert.showAlert(SendToWXActivity.this, "send text", editor, getString(R.string.app_share),
                    getString(R.string.app_cancel), (dialog, which) -> {
        ...
        findViewById(R.id.send_img).setOnClickListener(v -> MMAlert.showAlert(SendToWXActivity.this, getString(R.string.send_img),
        ...
        findViewById(R.id.send_music).setOnClickListener(v -> MMAlert.showAlert(SendToWXActivity.this, getString(R.string.send_music),
        ...
        findViewById(R.id.send_video).setOnClickListener(v -> MMAlert.showAlert(SendToWXActivity.this, getString(R.string.send_video),
        ...
        findViewById(R.id.send_webpage).setOnClickListener(v -> MMAlert.showAlert(SendToWXActivity.this, getString(R.string.send_webpage),
        ...
        // get token
        findViewById(R.id.get_token).setOnClickListener(v -> {
            // send oauth request
        ...
        findViewById(R.id.get_info).setOnClickListener(v -> {
        ...
        findViewById(R.id.unregister).setOnClickListener(v -> api.unregisterApp());
    }
