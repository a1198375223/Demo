...
public class Toasty {
    ...
    public static void showCustom(CharSequence text, int textColor, int iconRes, boolean withIcon, int duration) {
        show(AppUtils.app().getApplicationContext(), text, textColor, iconRes,
    ...
    public static void showCustom(CharSequence text, int textColor, int iconRes, int tintCololr, int duration) {
        show(AppUtils.app().getApplicationContext(), text, textColor, iconRes, tintCololr, true, true, duration);
    }
    ...
    public static void showCustom(CharSequence text, int iconRes, boolean withIcon, int duration) {
        show(AppUtils.app().getApplicationContext(), text, sTextColor, iconRes, CUSTOM_TOAST_DEFAULT_COLOR, true, withIcon, duration);
    }
    ...
    public static void showCustom(CharSequence text, boolean shouldTint, int tintColor, int duration) {
        show(AppUtils.app().getApplicationContext(), text, sTextColor, R.drawable.toast_normal_while_icon, tintColor, shouldTint, true, duration);
    }
