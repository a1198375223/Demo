...
import com.example.dialog.other.NotImplementedException;
...
public class MDRootLayout extends ViewGroup {
    ...
    private static final int INDEX_NEUTRAL = 0;  // neutral按钮的索引
    private static final int INDEX_NEGATIVE = 1; // negative按钮的索引
    private static final int INDEX_POSITIVE = 2; // positive按钮的索引
    ...
    private boolean mNoTitleNoPadding; // 是否没有标题且没有padding
