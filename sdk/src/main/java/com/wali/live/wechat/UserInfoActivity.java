...
import com.wali.live.wechat.utils.NetworkUtil;
...
public class UserInfoActivity extends Activity {
    ...
    private static class MyHandler extends Handler {
        ...
        public MyHandler(UserInfoActivity userInfoActivity){
            userInfoActivityWR = new WeakReference<>(userInfoActivity);
        }
        ...
        public void handleMessage(@NotNull Message msg) {
            ...
            switch (tag) {
                ...
                case NetworkUtil.GET_IMG: {
                    ...
                    handler.post(() -> ((ImageView)userInfoActivityWR.get().findViewById(R.id.headimg)).setImageBitmap(bitmap));
                    break;
                }
            }
        }
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acitivity_user_info);
    }
