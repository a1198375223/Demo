package com.wali.live.wechat.common;
...
public class MMAlert {
    ...
    public static AlertDialog showAlert(final Context context, final String msg, final String title) {
        ...
        builder.setPositiveButton(R.string.app_ok, (dialog, which) -> dialog.cancel());
    ...
    public static ProgressDialog showProgressDlg(final Context context, final String title, final String message, final boolean indeterminate, final boolean cancelable, final DialogInterface.OnCancelListener lCancel) {
        ...
        return ProgressDialog.show(context, title, message, indeterminate, cancelable, dialog -> {
            if (lCancel != null) {
    ...
    public static Dialog showAlert(final Context context, final String title, final String[] items, String exit, final OnAlertSelectId alertDo, DialogInterface.OnCancelListener cancelListener) {
        ...
        final ListView list = layout.findViewById(R.id.content_list);
