...
public class GetFromWXActivity extends Activity {
    ...
    private void initView() {
        ...
        findViewById(R.id.get_text).setOnClickListener(v -> {
        ...
        findViewById(R.id.get_img).setOnClickListener(v -> {
        ...
        findViewById(R.id.get_music).setOnClickListener(v -> {
        ...
        findViewById(R.id.get_video).setOnClickListener(v -> {
        ...
        findViewById(R.id.get_webpage).setOnClickListener(v -> {
        ...
        findViewById(R.id.get_appdata).setOnClickListener(v -> {
